...
alias omzpe="omz plugin enable"



# If you come from bash you might have to change your $PATH.
 export PATH=$HOME/bin:/usr/local/bin:/home/khaos/.local/bin:$PATH

# Path to your oh-my-zsh installation.
export ZSH="/home/khaos/.oh-my-zsh"
...
plugins=(git sudo web-search tmux yarn aliases)
